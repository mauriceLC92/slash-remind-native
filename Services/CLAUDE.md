...
| ---- | ---- | ------------ |
| `README.md` | CGEvent tap rationale, protocol-based API design, Sendable patterns, lifecycle invariants | Understanding service architecture, debugging concurrency, modifying services |
